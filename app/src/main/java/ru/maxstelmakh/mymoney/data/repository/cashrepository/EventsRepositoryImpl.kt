...
//    -------------------------------- Statistic --------------------------------
    override suspend fun getCategoriesForStatistic(): Flow<List<StatisticModelDomain>> = flow {
        eventsRepositoryDao.getCategoriesForStatistic().collect { listStatisticData ->
